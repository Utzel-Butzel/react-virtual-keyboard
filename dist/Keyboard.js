...
export default class extends React.Component {
    ...
    render() {
        if (this.props.options.type == 'textarea') {
            var element = React.createElement('textarea', { ref: 'keyboard', className: this.props.options.class, value: this.state.value, onChange: this.handleChange });
        } else {
            element = React.createElement('input', { ref: 'keyboard', className: this.props.options.class, value: this.state.value, onChange: this.handleChange });
        }
