...
class VirtualKeyboard extends Component {
  ...
  render() {
    ...
    if (this.props.options.type === 'textarea')
      element = (
        <textarea ref={node => this.keyboardRef = node} onFocus={()=>document.activeElement.blur()} value = { this.state.value } onChange = { this.handleChange } {...other}/>
      );
    else
      element = (
        <input ref={node => this.keyboardRef = node} onFocus={()=>document.activeElement.blur()} value = { this.state.value } onChange = { this.handleChange } {...other} />
      );
