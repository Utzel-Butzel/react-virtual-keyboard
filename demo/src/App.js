  ...
  render() {
    ...
    return (
	    <div>
	      ...
	      <Keyboard value='sdssddds' options={{type:'input', layout:'qwerty', autoAccept: true, alwaysOpen: false, color:'light', class:'sxcycx', layout: 'custom',display, customLayout}} callbackParent={this.onInputChanged} />
