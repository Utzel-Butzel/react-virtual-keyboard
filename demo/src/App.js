  ...
  render() {
    ...
    return (
	    <div>
	      ...
	      <Keyboard value={ this.state.textarea } name='thetextareaname' options={{type:'textarea', usePreview: false, layout:'qwerty', autoAccept: true, alwaysOpen: false, appendLocally: false, updateOnChange: true, color:'light', class:'sxcycx'}} callbackParent={this.onTextareaChanged} />
